...
<div class="wrap">
	...
	<form method="post" action="options.php">
		...
		<input type="hidden" name="image_cdn[https]" id="image_cdn_https" value="<?php echo $is_https_int; ?>" />
					...
					<fieldset>
						<label for="image_cdn_url" style="border-radius: 4px; border: 1px solid #8c8f94; background-color: #fff; color: #2c3338;">
							<select name="image_cdn[scheme]" id="image_cdn_scheme" style="border: none;">
								<option value="https://" <?php if ('https' === $url_scheme) echo 'selected'; ?>>https://</option>
								<option value="http://" <?php if ('http' === $url_scheme) echo 'selected'; ?>>http://</option>
							</select>
